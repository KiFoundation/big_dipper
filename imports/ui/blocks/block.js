    ...
    render() {
        ...
        if (proposer){
            ...
            return <Row className="block-info bg-white my-2 py-3 list-border">
                <Col xs={4} sm={2} className="text-truncate"><i className="fas fa-cube mr-2 light-color"></i> { this.props.block.hash}</Col>
                ...
                <Col xs={8}sm={3} md={2} lg={3} className="text-truncate"><Link className="primary-color font-800" to={"/validator/"+this.props.block.proposerAddress}><Avatar moniker={moniker} profileUrl={proposer.profile_url} address={this.props.block.proposerAddress} list={true} /> {moniker}</Link></Col>
