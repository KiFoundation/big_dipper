    ...
    render() {
        return(
            <Row className="header text-nowrap d-none d-sm-flex latest-block-page mb-3 mt-4" style={{ border: 0 }}>                
                ...
                <Col sm={2}><span className="d-none d-md-inline text-uppercase dark-color font-500"><T>common.height</T></span></Col>
                ...
                <Col sm={4} lg={3}><span className="d-none d-md-inline text-uppercase dark-color font-500"><T>common.time</T> (UTC)</span></Col>
            </Row>
        );
    }
}
